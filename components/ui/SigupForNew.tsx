...
export const SigupForNew = () => {
  return (
    <div className=' bg-[#dddddd55]  border  '>
          <div className='lg:container px-[15px]  mx-auto items-center lg:py-4 lg:flex justify-between'>
              ...
              <h3 className={cn(palyfair.className,'uppercase  sm:leading-5   lg:text-lg text-center sm:text-left  text-md font-bold my-4')}>Sign up for <span className='lg:text-2xl   '>newletter</span></h3>
